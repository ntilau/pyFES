...
```bash
open paper/MoE-DKL-FE.pdf
```

| File | Description |
|---|---|
| `paper/MoE-DKL-FE.pdf` | Compiled PDF (6 pages, IEEE format) |
| `paper/MoE-DKL-FE.tex` | LaTeX source |
| `paper/figs/fig_*.pdf` | Vector figure panels (generated by scripts in paper/figs/) |
