...
Figures~\ref{fig:uncert1} and~\ref{fig:uncert2} show the relative prediction error in dB for two held-out $\varepsilon_r$ values, computed as $20\log_{10}(1 + |\Delta S|/|S_{\mathrm{true}}|)$.
...
\caption{RMSE curves for S$_{11}$ and S$_{21}$ at $\varepsilon_r = 2.053$ (held-out). Error: $20\log_{10}(1 + |S_{\mathrm{pred}} - S_{\mathrm{true}}|/|S_{\mathrm{true}}|)$.}\label{fig:uncert1}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig_uncertainty_2.pdf}
\caption{RMSE curves for S$_{11}$ and S$_{21}$ at $\varepsilon_r = 2.196$ (held-out).}\label{fig:uncert2}
\end{figure}
