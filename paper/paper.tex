...
Figures~\ref{fig:uncert1} and~\ref{fig:uncert2} illustrate the predictive uncertainty for both S$_{11}$ and S$_{21}$ at two held-out $\varepsilon_r$ values. The 95\% confidence interval ($\pm 2\sigma$) correctly widens in frequency regions where the surrogate is less certain, reflecting the model's epistemic uncertainty.
...
\caption{Predictive mean and $\pm 2\sigma$ confidence interval for S$_{11}$ and S$_{21}$ at $\varepsilon_r = 2.053$ (held-out). Shaded bands: $\pm 2\sigma$; markers: FEM ground truth.}\label{fig:uncert1}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig_uncertainty_2.png}
\caption{Predictive mean and $\pm 2\sigma$ confidence interval for S$_{11}$ and S$_{21}$ at $\varepsilon_r = 2.196$ (held-out). Shaded bands: $\pm 2\sigma$; markers: FEM ground truth.}\label{fig:uncert2}
\end{figure}
