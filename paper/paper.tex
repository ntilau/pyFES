...
\author{\IEEEauthorblockN{Laurent Ntibarikure\IEEEauthorrefmark{1},
Stefano Selleri\IEEEauthorrefmark{2}}
\IEEEauthorblockN{\IEEEauthorrefmark{1}\textit{Department of Electrical and Computer Engineering}}
\IEEEauthorblockN{\IEEEauthorrefmark{1}\textit{University Name, City, Country}}
\IEEEauthorblockN{\IEEEauthorrefmark{1}Email: lntibarikure@example.com}
\IEEEauthorblockN{\IEEEauthorrefmark{2}\textit{Department of Information Engineering, University of Florence}}
\IEEEauthorblockN{\IEEEauthorrefmark{2}Via di Santa Marta 3, 50139 Firenze, Italy}
\IEEEauthorblockN{\IEEEauthorrefmark{2}Email: stefano.selleri@unifi.it}}
...
Figures~\ref{fig:uncert1} and~\ref{fig:uncert2} show the predicted and ground truth S-parameters alongside RMSE curves for two held-out $\varepsilon_r$ values.
...
\caption{Predicted and ground truth S$_{11}$ and S$_{21}$ with RMSE curves at $\varepsilon_r = 2.053$ (held-out). Solid: prediction; markers: FEM; dotted: RMSE.}\label{fig:uncert1}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig_uncertainty_2.pdf}
\caption{Predicted and ground truth S$_{11}$ and S$_{21}$ with RMSE curves at $\varepsilon_r = 2.196$ (held-out).}\label{fig:uncert2}
\end{figure}
