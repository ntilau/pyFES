...
\caption{Predictive mean and $\pm 2\sigma$ confidence interval for $\varepsilon_r = 2.053$ (held-out). Left: S$_{11}$; right: S$_{21}$. Shaded: $\pm 2\sigma$; dots: FEM ground truth.}\label{fig:uncert1}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig_uncertainty_2.png}
\caption{Predictive mean and $\pm 2\sigma$ confidence interval for $\varepsilon_r = 2.196$ (held-out). Left: S$_{11}$; right: S$_{21}$. Shaded: $\pm 2\sigma$; dots: FEM ground truth.}\label{fig:uncert2}
\end{figure}
