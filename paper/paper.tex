...
Figures~\ref{fig:uncert1} and~\ref{fig:uncert2} show predicted versus ground truth S-parameters for two held-out $\varepsilon_r$ values.
...
\caption{Overlaid S$_{11}$ and S$_{21}$ predictions at $\varepsilon_r = 2.053$ (held-out). Solid lines: DKL prediction; markers: FEM ground truth.}\label{fig:uncert1}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig_uncertainty_2.pdf}
\caption{Overlaid S$_{11}$ and S$_{21}$ predictions at $\varepsilon_r = 2.196$ (held-out). Solid lines: DKL prediction; markers: FEM ground truth.}\label{fig:uncert2}
\end{figure}
